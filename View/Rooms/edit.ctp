...
echo $this->Form->input('amount',array('class'=>'form-control','value'=>$data['Room']['amount'],'onkeypress'=>'validate(event)','between' => '<div class="col-lg-8">','after'=>'</div>','label'=>array('class'=>'col-lg-4 control-label','between'=>'<div class="form-group">','after'=>'div')));
