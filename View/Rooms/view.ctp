...
echo $this->Form->input('ubication',array('readonly'=>'true','value'=>$data['room']['Room']['amount'],'class'=>'form-control','between' => '<div class="col-lg-8">','after'=>'</div>','label'=>array('class'=>'col-lg-4 control-label','between'=>'<div class="form-group">','after'=>'div')));
